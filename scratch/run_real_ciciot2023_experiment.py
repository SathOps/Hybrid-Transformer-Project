...
def main():
    LOGGER.info("==========================================================")
    LOGGER.info("STARTING REAL CICIoT2023 CNN-TRANSFORMER BASELINE EXPERIMENT")
    LOGGER.info("==========================================================")
    
    data_dir = PROJECT_ROOT / "data" / "processed" / "prepared" / "subsampled_train"
    checkpoint_dir = PROJECT_ROOT / "checkpoints" / "cnn_transformer" / "real_ciciot2023"
    results_dir = PROJECT_ROOT / "results" / "cnn_transformer" / "real_ciciot2023"
    ...
    LOGGER.info("==========================================================")
    LOGGER.info("REAL CICIoT2023 CNN-TRANSFORMER EXPERIMENT COMPLETE")
    LOGGER.info("==========================================================")
