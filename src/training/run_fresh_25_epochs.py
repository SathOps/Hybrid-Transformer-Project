"""Orchestration script for Fresh 25-Epoch CNN-Transformer Baseline on Real CICIoT2023."""
...
def main() -> None:
    ...
    checkpoint_dir = Path("checkpoints/cnn_transformer/real_ciciot2023/fresh_25_epochs").resolve()
    output_dir = Path("results/cnn_transformer/real_ciciot2023/fresh_25_epochs").resolve()
    ...
    log_and_print("==================================================")
    log_and_print("STARTING FRESH 25-EPOCH CNN-TRANSFORMER BASELINE EXPERIMENT")
    ...
    log_and_print("\n==================================================")
    log_and_print("TRAINING COMPLETED / EARLY STOPPED")
    ...
    log_and_print("\n==================================================")
    log_and_print("FINAL 25-EPOCH BASELINE EXPERIMENT SUMMARY")
    log_and_print("==================================================")
    log_and_print(f"Epochs Completed: {epochs_completed}/25")
