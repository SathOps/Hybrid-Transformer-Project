"""Orchestration script for Fresh 25-Epoch Class-Weighted CNN-Transformer Baseline on Real CICIoT2023."""
...
CLASS_WEIGHTS = {
    0: 0.488070,  # Benign
    1: 41.029856, # BruteForce
    2: 0.750349,  # DDoS
    3: 0.750349,  # DoS
    4: 0.750349,  # Mirai
    5: 1.101898,  # Spoofing
    6: 47.568603, # Web-based
}
...
def main() -> None:
    ...
    checkpoint_dir = Path("checkpoints/cnn_transformer/real_ciciot2023/class_weighted").resolve()
    output_dir = Path("results/cnn_transformer/real_ciciot2023/class_weighted").resolve()
    ...
    log_and_print("==================================================")
    log_and_print("STARTING FRESH 25-EPOCH CLASS-WEIGHTED CNN-TRANSFORMER BASELINE EXPERIMENT")
    ...
    log_and_print(f"Class Weights: {CLASS_WEIGHTS}")
    log_and_print("==================================================")
    ...
    log_and_print("\n==================================================")
    log_and_print("CLASS-WEIGHTED TRAINING COMPLETED / EARLY STOPPED")
    ...
    log_and_print("\n==================================================")
    log_and_print("FINAL 25-EPOCH CLASS-WEIGHTED EXPERIMENT SUMMARY")
    log_and_print("==================================================")
    log_and_print(f"Epochs Completed: {epochs_completed}/25")
